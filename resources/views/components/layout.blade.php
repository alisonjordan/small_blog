...
<html lang="en">
  <head>
    ...
    <title> @isset($doctitle)
      {{$doctitle}} | {{ config('app.name', 'Laravel') }}
  ...
  <body>
    <header class="header-bar mb-3">
      <div class="container d-flex flex-column flex-md-row align-items-center p-3">
        <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">{{ config('app.name', 'Laravel') }}</a></h4>
...
<footer class="border-top text-center small text-muted py-3">
    <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">{{ config('app.name', 'Laravel') }}</a>. All rights reserved.</p>
  </footer>
